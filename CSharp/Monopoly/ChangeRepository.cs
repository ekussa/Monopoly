...
namespace Monopoly
{
    ...
    {
        private readonly ChanceStack _stack;
        private int _index;

        public ChangeRepository(List<Player> players)
        {
            _index = 0;
            _stack = new ChanceStack(
                new List<ChanceCard>
                {
                    new EarnChangeCard(
                        50,
                    ...
                    new SpendChangeCard(
                        30,
                        "Mais dinheiro pra vagabundo ai! Voce estacionou seu carro em local proibido e ainda entrou na contra mão."),
                    new SpendChangeCard(
                        50,
                        "Voce tem que pagar os bandidos do governo no imposto de renda.")
                }.AsRandom()
        ...
        {
            var ret = _stack[_index];
            _index = ++_index % _stack.Count;
            return ret;
        }
   }
}